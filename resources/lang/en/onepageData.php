    ...
    'creations' => [
        ...
        'sections' => [
            [
                ...
                'images' => [
                    ['src' => "img/creations/dessinsVib/Alchimia.webp", 'name' => "Alchimia"],
                    ['src' => "img/creations/dessinsVib/Alma.webp", 'name' => "Alma"],
                    ['src' => "img/creations/dessinsVib/AmnesiaeMemoria.webp", 'name' => "Amnesia e Memoria"],
                    ['src' => "img/creations/dessinsVib/Feminae.webp", 'name' => "Feminae"],
                    ['src' => "img/creations/dessinsVib/Imayah.webp", 'name' => "Imayah"],
                    ['src' => "img/creations/dessinsVib/Immensita.webp", 'name' => "Immensità"],
                    ['src' => "img/creations/dessinsVib/IsisLumiereAmen.webp", 'name' => "Isis Lumière Amen"],
                    ['src' => "img/creations/dessinsVib/Luminescence.webp", 'name' => "Luminescence"],
                    ['src' => "img/creations/dessinsVib/Nirmayah.webp", 'name' => "Nirmayah"],
                    ['src' => "img/creations/dessinsVib/OrNuméaIsisHoden.webp", 'name' => "Or Numéa Isis Hoden"],
                    ['src' => "img/creations/dessinsVib/Yarinah.webp", 'name' => "Yarinah"],
                    ['src' => "img/creations/dessinsVib/Yurta.webp", 'name' => "Yurta"],
                ],
            ],
            [
                'type' => "carousel",
