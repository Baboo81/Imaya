    ...
    'creations' => [
        ...
        'sections' => [
            [
                ...
                'images' => [
                    [ 'src' => "img/creations/dessinsVib/Alchimia11.jpeg", 'name' => "Alchimia" ],
                    [ 'src' => "img/creations/dessinsVib/Alma1.jpeg", 'name' => "Alma" ],
                    [ 'src' => "img/creations/dessinsVib/AmnesiaeMemoria3.jpeg", 'name' => "Amnesia e Memoria" ],
                    [ 'src' => "img/creations/dessinsVib/Feminae5.jpeg", 'name' => "Feminae" ],
                    [ 'src' => "img/creations/dessinsVib/Imayah6.jpeg", 'name' => "Imayah" ],
                    [ 'src' => "img/creations/dessinsVib/Immensita7.jpeg", 'name' => "Immensità" ],
                    [ 'src' => "img/creations/dessinsVib/IsisLumièreAmen4.jpeg", 'name' => "Isis Lumière Amen" ],
                    [ 'src' => "img/creations/dessinsVib/Luminescence8.jpeg", 'name' => "Luminescence" ],
                    [ 'src' => "img/creations/dessinsVib/Nirmayah9.jpeg", 'name' => "Nirmayah" ],
                    [ 'src' => "img/creations/dessinsVib/OrNuméaIsisHoden12.jpeg", 'name' => "Or Numéa Isis Hoden" ],
                    [ 'src' => "img/creations/dessinsVib/Yarinah2.jpeg", 'name' => "Yarinah" ],
                    [ 'src' => "img/creations/dessinsVib/Yurta10.jpeg", 'name' => "Yurta" ],
                ],
            ],
            [
                'type'         => "carousel",
