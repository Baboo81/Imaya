...
return [
    'activite_title' => "Collaborazioni",
    'activite_subTitle' => "Laboratori",
    ...
    'qui_suis_je' => [
        'mainTitle'   => "Chi sono ?",
        'imgProfil'   => "img/quiSuisJe/profil.jpg",
        ...
        'txtProfil2' => "Inoltre, durante queste esplorazioni, le mie risorse sono state guidate e ispirate dall’esperienza precoce della trance. Questa si è manifestata fin dalla giovane età, ma ci sono voluti molti anni per riconoscerla, comprenderla, stabilizzarmi in essa, accettarla e armonizzare sufficientemente la mia personalità per accoglierla con la massima precisione e allineamento, per il mio bene e quello di tutti.",
        'txtProfil3' => "Da circa dieci anni, essa è colei che unisce tutti questi linguaggi appresi, sperimentati e integrati in uno solo: quello della guarigione e dell’evoluzione dell’anima e dello spirito attraverso la parola, il canto e il tocco...",
        'secondTitle' => "Tra Bruxelles e Noto",
        'imgBxl'      => "img/quiSuisJe/Bxl.jpg",
        'imgSicile'   => "img/quiSuisJe/Sicile.jpg",
        ...
        'imgSliderCabinet' => [
            "img/quiSuisJe/cabinetBxl/cabinet1.jpg",
            "img/quiSuisJe/cabinetBxl/cabinet2.jpg",
            "img/quiSuisJe/cabinetBxl/cabinet3.jpg",
            "img/quiSuisJe/cabinetBxl/cabinet4.jpg",
            "img/quiSuisJe/cabinetBxl/cabinet5.jpeg",
            "img/quiSuisJe/cabinetBxl/cabinet6.jpg",
            "img/quiSuisJe/cabinetBxl/cabinet7.jpeg",
            "img/quiSuisJe/cabinetBxl/cabinet8.jpeg",
        ],
    ],
    'soins' => [
        ...
        'cards' => [
            [
                'img'     => "img/soins/card1.jpg",
                'title'   => "Trattamento energetico",
                'text'    => "Questo trattamento derivato dal Reiki rigenera il sistema nervoso e rafforza la vitalità. Armonizza corpo e mente e si riceve vestiti.",
                'details' => [
                    ['title' => "Luogo",   'text' => "Bruxelles & Sicilia"],
                    ['title' => "Durata",  'text' => "1h30"],
                    ['title' => "Prezzo",  'text' => "110 €"],
                ],
            ],
            [
                'img'     => "img/soins/card2.jpg",
                'title'   => "Massaggio vibratorio",
                'text'    => "Con un tocco allo stesso tempo deciso e delicato, questo massaggio con olio libera le tensioni radicate nelle profondità del corpo e della mente. È arricchito e accompagnato dalle vibrazioni del canto intuitivo…",
                'details' => [
            ...
            [
                'img'     => "img/soins/card3.jpg",
                'title'   => "Accompagnamento terapeutico",
                'text'    => "Attraverso la parola radicata negli strumenti della psicologia del profondo…",
                'details' => [
                    ['title' => "Luogo",                'text' => "A Bruxelles e in Sicilia"],
            ...
            [
                'img'     => "img/soins/card5.jpg",
                'title'   => "Trattamento dell’anima",
                'text'    => "Sostenuto dalla trance, questo trattamento è un dialogo con l’anima…",
                'details' => [
                    ['title' => "Luogo",   'text' => "A Bruxelles e in Sicilia"],
                    ['title' => "Durata",  'text' => "1h30"],
                    ['title' => "Prezzo",  'text' => "110 €"],
            ...
            [
                'img'     => "img/soins/card6.PNG",
                'title'   => "Bagno sonoro",
                'text'    => "In cerchio fino a 12 persone dentro una yurta mongola, questo trattamento vibratorio è un’immersione nell’universo dei suoni…",
                'details' => [
    ...
    'creations' => [
        'mainTitle' => "Le creazioni",
        'sections' => [
            [
                'type'        => "carousel",
                'title'       => "Disegni vibrazionali",
                'description' => "Il disegno realizzato in stato di trance si presenta qui come un'onda e risonanza dei materiali interiori per offrire all'inconscio una via di trasmissione ed espressione del suo contenuto, ma anche di armonizzazione. Come un sogno pieno di simboli e significati, un mantra, una preghiera, l'immagine del disegno, il suo nome, i suoi colori e le sue forme sono al contempo ricettori e emittitori. Ricettori come uno specchio delle immagini interiori quando trovano una via per rivelarsi alla coscienza. Emittitori quando la “medicina” unica del disegno viene captata dalle onde cerebrali e armonizza così il livello vibrazionale..",
                'cta'         => "I disegni vibrazionali sono disponibili su richiesta",
                'images' => [
                    ['src' => "assets/img/creations/dessinsVib/Alchimia.webp", 'name' => "Alchimia"],
                    ['src' => "assets/img/creations/dessinsVib/Alma.webp", 'name' => "Alma"],
                    ['src' => "assets/img/creations/dessinsVib/AmnesiaeMemoria.webp", 'name' => "Amnesia e Memoria"],
                    ['src' => "assets/img/creations/dessinsVib/Feminae.webp", 'name' => "Feminae"],
                    ['src' => "assets/img/creations/dessinsVib/Imayah.webp", 'name' => "Imayah"],
                    ['src' => "assets/img/creations/dessinsVib/Immensita.webp", 'name' => "Immensità"],
                    ['src' => "assets/img/creations/dessinsVib/IsisLumiereAmen.webp", 'name' => "Isis Lumière Amen"],
                    ['src' => "assets/img/creations/dessinsVib/Luminescence.webp", 'name' => "Luminescence"],
                    ['src' => "assets/img/creations/dessinsVib/Nirmayah.webp", 'name' => "Nirmayah"],
                    ['src' => "assets/img/creations/dessinsVib/OrNuméaIsisHoden.webp", 'name' => "Or Numéa Isis Hoden"],
                    ['src' => "assets/img/creations/dessinsVib/Yarinah.webp", 'name' => "Yarinah"],
                    ['src' => "assets/img/creations/dessinsVib/Yurta.webp", 'name' => "Yurta"],
                ],
            ],
            [
                'type'         => "carousel",
                'title'        => "Illustrazioni & dipinti",
                'description'  => "Le illustrazioni nascono secondo incontri e colpi di cuore. Realizzate con tecniche miste e create in stato di trance, si propongono come portavoce di un progetto, di un'opera, di un’idea, di uno slancio con cui dialogano fino a sposarne l’essenza.",
                'description2' => "Anche i dipinti, realizzati con tecniche miste e in stato di trance, si offrono come un'opera che accompagna un momento di vita, un contenuto vibrazionale al servizio dell’essere, una ricerca di bellezza in favore dell’armonia.",
                'cta'          => "Illustrazioni e dipinti sono disponibili su richiesta",
                'images'       => [
                    "img/creations/peintures/peinture1.jpg",
                    "img/creations/peintures/peinture2.jpg",
                    "img/creations/peintures/peinture3.jpg",
                    "img/creations/peintures/peinture5.jpg",
                    "img/creations/peintures/peinture6.jpg",
                    "img/creations/peintures/peinture7.jpeg",
                    "img/creations/peintures/peinture8.jpeg",
                    "img/creations/peintures/peinture9.jpeg",
                    "img/creations/peintures/peinture10.jpg",
                    "img/creations/peintures/peinture11.jpeg",
                    "img/creations/peintures/peinture12.jpg",
                    "img/creations/peintures/peinture13.jpg",
                    "img/creations/peintures/peinture14.JPG",
                    "img/creations/peintures/peinture15.jpeg",
                    "img/creations/peintures/peinture16.jpeg",
                    "img/creations/peintures/peinture17.jpeg",
                    "img/creations/peintures/peinture18.jpeg",
                    "img/creations/peintures/peinture20.jpg",
                    "img/creations/peintures/peinture21.jpg",
                    "img/creations/peintures/peinture22.jpg",
                    "img/creations/peintures/peinture23.jpg",
                    "img/creations/peintures/peinture24.JPG",
                    "img/creations/peintures/peinture25.JPG",
                ],
            ],
            [
                ...
                'items' => [
                    " 'Passage' (trimestrale) in collaborazione con Jessica Dell\'Utri",
    ...
    'activites' => [
        'ateliers' => [
            [
                ...
                'sliderPath' => "activites/ateliers&collaborations/ceremonieDesPlantes/",
            ],
            [
                'titre' => "Gioielli dell'anima",
                'image' => "profilActivites.jpeg",
                'txt_propose' => "Laboratorio in collaborazione con :",
                ...
                'sliderPath' => "activites/ateliers&collaborations/bijoux/",
            ],
        ],
        'retraites' => [
            [
    ...
    'casaImayah' => [
        ...
        'imgCasaImayah' => "img/casaImayah/CasaImayah.jpg",
        'imgPiscine' => "img/casaImayah/piscine.jpg",
    ],
    'contact' => [
        'name' => "Cognome",
