    ...
    'creations' => [
        ...
        'sections' => [
            [
                ...
                'images' => [
                    ['src' => "img/creations/dessinsVib/Alchimia11.webp", 'name' => "Alchimia"],
                    ['src' => "img/creations/dessinsVib/Alma1.webp", 'name' => "Alma"],
                    ['src' => "img/creations/dessinsVib/AmnesiaeMemoria3.webp", 'name' => "Amnesia e Memoria"],
                    ['src' => "img/creations/dessinsVib/Feminae5.webp", 'name' => "Feminae"],
                    ['src' => "img/creations/dessinsVib/Imayah6.webp", 'name' => "Imayah"],
                    ['src' => "img/creations/dessinsVib/Immensita7.webp", 'name' => "Immensità"],
                    ['src' => "img/creations/dessinsVib/IsisLumièreAmen4.webp", 'name' => "Isis Lumière Amen"],
                    ['src' => "img/creations/dessinsVib/Luminescence8.webp", 'name' => "Luminescence"],
                    ['src' => "img/creations/dessinsVib/Nirmayah9.webp", 'name' => "Nirmayah"],
                    ['src' => "img/creations/dessinsVib/OrNuméaIsisHoden12.webp", 'name' => "Or Numéa Isis Hoden"],
                    ['src' => "img/creations/dessinsVib/Yarinah2.webp", 'name' => "Yarinah"],
                    ['src' => "img/creations/dessinsVib/Yurta10.webp", 'name' => "Yurta"],
                ],
            ],
            [
                'type'         => "carousel",
